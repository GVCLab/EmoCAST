...
setup.py
----
This is the main setup file for the emocast face animation project. It defines the package
...
packages = \
    ['emocast', 'emocast.datasets', 'emocast.models', 'emocast.animate', 'emocast.utils']
...
setup_kwargs = {
    ...
    'version': '0.1.0',
    'description': '',
    'long_description': '# emotional talking head',
    'author': 'Your Name',
