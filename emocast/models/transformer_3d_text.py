...
from .attention_text import (
                        EmoCrossAudioTemporalBasicTransformerBlock,
        ...
        if use_audio_module:
            self.transformer_blocks = nn.ModuleList(
                [
                    ...
                    #EmoAdainAudioTemporalBasicTransformerBlock(
                    #EmoCatAudioTemporalBasicTransformerBlock(
                    EmoCrossAudioTemporalBasicTransformerBlock(
                    #SemiAudioTemporalBasicTransformerBlock(
                        inner_dim,
                        num_attention_heads,
                        attention_head_dim,
                        dropout=dropout,
